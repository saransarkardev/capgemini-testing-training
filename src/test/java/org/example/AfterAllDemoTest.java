...
// Implementation of AfterAll Annotation. (After all the Test methods....this method will run where we will use @AfterAll annotation.
public class AfterAllDemoTest {
    ...
    static void tearDownAfterAll() {
        calculator = null;
        System.out.println("tearDownAfterAll method is calling...");
    }
